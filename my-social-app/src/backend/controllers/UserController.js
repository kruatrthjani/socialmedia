...
export const getOneUserHandler = function (schema, request) {
...
export const bookmarkPostHandler = function (schema, request) {
  ...
  try {
    ...
    user.bookmarks.push({ _id:post._id, username: post.username, content: post.content, mediaURL: post.mediaURL, createdAt: post.createdAt, updatedAt: post.updatedAt });
